...
public class Robot extends TimedRobot {
    ...
    */
    ...
    private final WPI_VictorSPX leftVictor = new WPI_VictorSPX(0);
    private final WPI_VictorSPX rightVictor = new WPI_VictorSPX(3);
    ...
    private CANSparkMax rightSpark = new CANSparkMax(1, MotorType.kBrushless);
    private CANSparkMax leftSpark = new CANSparkMax(2, MotorType.kBrushless);
    private CANSparkMax rightSpark2 = new CANSparkMax(3, MotorType.kBrushless);
    private CANSparkMax leftSpark2 = new CANSparkMax(4, MotorType.kBrushless);
    ...
    public void robotInit() {
        ...
        drive = new DifferentialDrive(rightSpark, leftSpark);
        drive2 = new DifferentialDrive(rightSpark2, leftSpark2);
    ...
    public void teleopPeriodic() {
        ...
        if (DriverOne.getRawAxis(Controller.TRIGGER_RIGHT) > 0) {
            drive.curvatureDrive(DriverOne.getRawAxis(Controller.TRIGGER_RIGHT)*(-1), DriverOne.getRawAxis(Controller.ANALOG_LEFT), false);
            drive2.curvatureDrive(DriverOne.getRawAxis(Controller.TRIGGER_RIGHT)*(-1), DriverOne.getRawAxis(Controller.ANALOG_LEFT), false);
        }else if (DriverOne.getRawAxis(Controller.TRIGGER_LEFT) > 0){
            drive.curvatureDrive(DriverOne.getRawAxis(Controller.TRIGGER_LEFT), DriverOne.getRawAxis(Controller.ANALOG_LEFT)*-1, false);
            drive2.curvatureDrive(DriverOne.getRawAxis(Controller.TRIGGER_LEFT), DriverOne.getRawAxis(Controller.ANALOG_LEFT)*-1, false);
        }
